...
knownfusionlist <- c("ABI1+KMT2A", "ABL1+BCR", "ABL1+ETV6", "ABL1+NUP214", "ACE+KPNB1",
  "ACSL3+ETV1", "ACTB+GLI1", "ACTN4+KMT2A", "AFDN+KMT2A", "AFF1+KMT2A",
  "AFF3+KMT2A", "AFF4+KMT2A", "AGGF1+RAF1", "AGK+BRAF", "AKAP13+RET", "AKAP9+BRAF",
  "AKT3+ARHGAP30", "AKT3+PLD5", "AKT3+ZEB2", "ALK+ATIC", "ALK+CARS",
  ...
  "EGFR+SEC61G", "EGFR+SEPT14", "EIF3E+RSPO2", "ELAVL3+FGFR3",
  ...
  "SS18+SSX1", "SS18+SSX2", "SS18+SSX4", "STIL+TAL1", "TBL1XR1+TP63",
  "TERT+TRIO", "TG+THADA")
