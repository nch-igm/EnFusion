...
**Publication:** [Uhrig, S., et al. (2021) Accurate and efficient detection of gene fusions from RNA sequencing data. Genome Research.](https://genome.cshlp.org/content/31/3/448) <br><br>  
...
**Publication:** [Tian, L., et al. (2020) CICERO: a versatile method for detecting complex and diverse driver fusions using cancer RNA sequencing data. Genome Biology](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-020-02043-x) <br><br>
